...
import com.flyzebra.vrplayer.listener.UiMessageListener;
import com.flyzebra.vrplayer.util.Auth;
import com.flyzebra.vrplayer.util.AutoCheck;
import com.flyzebra.vrplayer.util.FileUtil;
import com.flyzebra.vrplayer.util.IOfflineResourceConst;
...
public class MiniActivity extends AppCompatActivity implements IOfflineResourceConst {
    ...
    private void initTTs() {
        ...
        mSpeechSynthesizer.setAudioAttributes(0,0);
    ...
    private boolean checkOfflineResources() {
        ...
        for (String path : filenames) {
            ...
            if (!f.canRead()) {
                print("[ERROR] 文件不存在或者不可读取，请从demo的assets目录复制同名文件到：" + f.getAbsolutePath());
                print("[ERROR] 初始化失败！！！");
                return false;
            }
        }
