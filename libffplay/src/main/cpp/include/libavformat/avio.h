...
typedef struct AVIOContext {
     ...
     *
     */
    u_char *buffer;  /**< Start of the buffer. */
    int buffer_size;        /**< Maximum buffer size */
    u_char *buf_ptr; /**< Current position in the buffer */
    u_char *buf_end; /**< End of the data, may be less than
...
void avio_write(AVIOContext *s, const u_char *buf, int size);
 ...
 */
int avio_read(AVIOContext *s, u_char *buf, int size);
